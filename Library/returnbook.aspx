...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div class="alert alert-dismissible fade " id="Div1" runat="server" role="alert">
        <strong id="strong2" runat="server">Success!</strong> <span id="Span1" runat="server"></span>
        ...
        <div class="container backccolor background">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <asp:TextBox ID="TextBox2" CssClass="form-control" runat="server" placeholder="Book code"></asp:TextBox>
                </div>
                <div class="col-md-4">
                    <label for="inputState">Unique Code</label><br />
                    <asp:TextBox ID="TextBox3" CssClass="form-control" runat="server" placeholder="Unique code"></asp:TextBox>
                </div>
                <div class="col-md-1">
                    <span id="TextBox6" runat="server"></span>
                    <br />
                    <asp:Button ID="Button1" runat="server" CssClass=" btn btn-success" Text="Issue" OnClick="Button1_Click" />
                </div>
                <div class="col-md-12">
