<%@ Page Title="" Language="C#" MasterPageFile="~/Library/Library.master" AutoEventWireup="true" CodeFile="IssueBook.aspx.cs" Inherits="Library_IssueBook" %>
        ...
        <div class="container background">
            <div class="row">
               ...
               <div class="form-group col-md-6">
                ...
                <div class="col-md-6">
                    <label for="inputname">Issue Date</label><br />
                    <%--<input type="text" class="form-control" runat="server" id="fname" placeholder="First name" />--%>
